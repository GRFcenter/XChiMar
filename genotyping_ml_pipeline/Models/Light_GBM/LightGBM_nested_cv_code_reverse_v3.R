#########################################################################################################
# 0.  Machine Learning # Build Marmoset Chimerism Classification Model       ##    LightGBM Reverse model
#########################################################################################################
...
#  CHROM  POS   abratio       Y
# 1 NC_048383.1 3043 0.5000000 alt_ref
# 2 NC_048383.1 3073 0.4000000 alt_ref
# 3 NC_048383.1 3088 0.8181818 alt_alt
# 4 NC_048383.1 3117 0.9473684 alt_ref
# 5 NC_048383.1 3132 0.1090909 ref_ref
# 6 NC_048383.1 3134 0.2222222 alt_ref
...
# 			  Actual
# Predicted      0      1      2
#        0 178115 270505 135315
#        1  80142 122461  60701
#        2  72485 111638  56280


#  Calculate final test accuracy
test_accuracy <- sum(diag(test_conf_matrix)) / sum(test_conf_matrix)
cat("\n===== Final Test Set Accuracy:", test_accuracy, "=====\n")
# ===== Final Test Set Accuracy: 0.3281006 =====
...
# Precision (per class): 0.3050254 0.4650936 0.2341069 


cat("Recall (per class):", test_recall, "\n")
# Recall (per class): 0.5385315 0.2426873 0.2230713 


cat("F1-score (per class):", test_f1_score, "\n")
# F1-score (per class): 0.3894599 0.3189471 0.2284559

# Error Rate  
test_error_rate <- 1 - test_accuracy
cat("Error Rate:", test_error_rate, "\n")
# Error Rate: 0.6718994 
...
AUPRC (per class):  0.3003642 0.4694576 0.2301917
